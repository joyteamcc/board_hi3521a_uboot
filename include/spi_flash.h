...
#define ID_MANU_S                       0x01    /* Spansion Manufacture ID */
#define ID_MANU_W                       0xef    /* Winbond  Manufacture ID */
#define ID_MANU_MX                      0xc2    /* MXIC Manufacture ID */
#define ID_MANU_N                       0x20    /* Micron Manufacture ID */
#define ID_MANU_GD                      0xc8    /* GD Manufacture ID */
#define ID_MANU_F                       0x8c    /* ESMT Manufacture ID */
#define ID_MANU_EN                      0x1c    /* CFeon Manufacture ID */
